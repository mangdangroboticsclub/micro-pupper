...
ESP_EVENT_DEFINE_BASE(HAVEN_STATE_EVENTS);
...
void DeviceStateEventManager::PostStateChangeEvent(DeviceState previous_state, DeviceState current_state) {
    ...
    esp_event_post(HAVEN_STATE_EVENTS, HAVEN_STATE_CHANGED_EVENT, &event_data, sizeof(event_data), portMAX_DELAY);
}
...
DeviceStateEventManager::DeviceStateEventManager() {
    ...
    ESP_ERROR_CHECK(esp_event_handler_register(HAVEN_STATE_EVENTS, HAVEN_STATE_CHANGED_EVENT, 
...
DeviceStateEventManager::~DeviceStateEventManager() {
    esp_event_handler_unregister(HAVEN_STATE_EVENTS, HAVEN_STATE_CHANGED_EVENT, nullptr);
}